...
const EMOTE_OPTIONS: EmoteOption[] = [
  ...
  { id: 'ta-za-sho', label: 'Та за шо', Icon: CircleHelp, color: '#fb7185', audioSrc: '/assets/emotes/ta-za-sho.mp3', gain: 0.75 },
  ...
  { id: 'penis', label: 'Пеніс', Icon: SmilePlus, color: '#e879f9', audioSrc: '/assets/emotes/penis.m4a', gain: 0.45 },
];
